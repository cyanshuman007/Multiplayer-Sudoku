...
public interface SudokuConstants {
	...
	public static final Color BLOCK_COLOR1 = new Color( 0, 204, 255 );
	public static final Color BLOCK_COLOR2 = new Color( 0, 255, 204 );
	public static final Color BLOCK_BORDER_COLOR = Color.DARK_GRAY;
	public static final Color CELL_BORDER_COLOR = Color.GRAY;
	public static final Color UNMODIFIABLE_COLOR = Color.GRAY;
